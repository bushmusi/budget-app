...
category1 = Category.create(name: 'As beza', icon: 'home', user: user1)
category2 = Category.create(name: 'Make up', icon: 'pen', user: user1)
category3 = Category.create(name: 'Kids', icon: 'ball', user: user1)
category4 = Category.create(name: 'Transport', icon: 'bus', user: user2)
